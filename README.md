...
- [Agent Graph Architecture](#agent-graph-architecture)
  ...
  - [1.1 Langgraph.json là gì?](#11-langgraphjson-là-gì)
  - [1.2 MCP dùng để làm gì? Vì sao chọn MCP?](#12-mcp-dùng-để-làm-gì-vì-sao-chọn-mcp)
  - [1.3 Supervisor là gì?](#13-supervisor-là-gì)
